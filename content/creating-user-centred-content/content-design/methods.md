...
To create user-centred content you need to [research with your users](/creating-user-centred-content/using-existing-research), which includes [using existing research](/user-research/planning-user-research/using-existing-research-data/).
