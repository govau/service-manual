module.exports = {
		...
		document.keywords = "commonwealth style manual online, content guidelines, government writing style guide"
		...
		document.keywords = "rules for writing numbers in australia";
