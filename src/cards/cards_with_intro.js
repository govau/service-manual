...
const CardsWithIntro = ( page ) => (
	<div className="au-body au-grid">
		<div className="container-fluid">
			<div className="row">
				<div className={"col-lg-offset-3 col-md-offset-3 col-md-9 col-lg-9 cards cardswithintro__container "+ (page.oddrow ? 'homepagebanner__oddrow cardswithintro__oddrow' : '')}>
